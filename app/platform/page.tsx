...
export const metadata: Metadata = { title: "AI-assisted echocardiography platform", description: "Explore Horalix: a DICOM echocardiography workflow for structured measurements, contextual overlays, and clinician-controlled review.", alternates: { canonical: "/platform" } };

const software = { "@context": "https://schema.org", "@type": "SoftwareApplication", "@id": "https://horalix.com/platform#software", name: "Horalix", applicationCategory: "HealthApplication", operatingSystem: "Web", description: "Pilot-stage AI-assisted echocardiography workflow for clinician review.", publisher: { "@id": "https://horalix.com/#organization" }, url: "https://horalix.com/platform", offers: { "@type": "Offer", availability: "https://schema.org/LimitedAvailability" } };
...
export default function Platform() {
  return <>
    ...
    <SplitCta /><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(software) }} />
  </>;
}
