  ...
  return (
    <figure className={compact ? "product-frame compact" : "product-frame"}>
      <div className="product-topbar">
        ...
        <div className="study-state"><span /> Brand sequence</div>
      </div>
      <div className="product-media brand-film-media">
        <video
          ...
          width={1280}
          height={720}
          aria-label="Horalix heart-to-mark brand sequence"
          tabIndex={-1}
        >
      ...
      <figcaption>Illustrative brand film · No patient data · Not for diagnostic use</figcaption>
    </figure>
  );
}
